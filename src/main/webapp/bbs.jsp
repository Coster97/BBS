		...
		<nav class="navbar navbar-default">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav">
					...
					<li>
					<li class="active"><a href="bbs.jsp">커뮤니티</a>
					<li>
...
<br></br>
	...
	<div class="container">
		<div class="jumbotron">
			<h4>커뮤니티</h4>
			<span>매너는 기본! 다양한 이야기로 소통해보세요.</span>
		</div>
		<div>
			<button class="btn-study">스터디모집</button>
			<button class="btn-study">프로젝트모집</button>
			<button class="btn-study">공모전모집</button>
			<button class="btn-study">자유글</button>
		</div>
		<div>
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown"><a href="#" class="dropdown-toggle"
