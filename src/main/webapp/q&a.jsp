...
<body>
		...
		<nav class="navbar navbar-default">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav">
					...
					<li>
					<li class="active"><a href="q&a.jsp">Q&A</a>
					<li>
	...
	<div class="container">
		<div class="jumbotron">
			<h4>Q&A</h4>
			<span>좋은 질문과 답변으로 지식을 공유하세요.</span>
			<span>사담은 커뮤니티를 이용해주세요!</span>
		</div>
		<div>
			<button class="btn-study">프로그래밍</button>
			<button class="btn-study">취업</button>
			<button class="btn-study">테크뉴스</button>
		</div>
		<div>
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown"><a href="#" class="dropdown-toggle"
	...
	<div class = "container">
		<div class="row">
			...
			%>
			<a href="write.jsp" class="btn btn-success pull-right">질문하기</a>
			<br></br>
			<br></br>
			<br></br>
			<br></br>
